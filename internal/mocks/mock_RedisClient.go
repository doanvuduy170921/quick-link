...
func (_m *MockRedisClient) Expire(ctx context.Context, key string, ttl time.Duration) error {
...
//   - key string
//   - ttl time.Duration
func (_e *MockRedisClient_Expecter) Expire(ctx interface{}, key interface{}, ttl interface{}) *MockRedisClient_Expire_Call {
	return &MockRedisClient_Expire_Call{Call: _e.mock.On("Expire", ctx, key, ttl)}
}

func (_c *MockRedisClient_Expire_Call) Run(run func(ctx context.Context, key string, ttl time.Duration)) *MockRedisClient_Expire_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_m *MockRedisClient) Incr(ctx context.Context, key string) (int64, error) {
	ret := _m.Called(ctx, key)
...
func (_c *MockRedisClient_Incr_Call) Return(_a0 int64, _a1 error) *MockRedisClient_Incr_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRedisClient_Incr_Call) RunAndReturn(run func(context.Context, string) (int64, error)) *MockRedisClient_Incr_Call {
	_c.Call.Return(run)
	return _c
}
